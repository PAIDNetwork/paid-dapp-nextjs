      ...
      <div className='menu mt-5'>
        <ul className='pl-3' style={isOpen ? {} : { paddingLeft: '1.5rem' }}>
          <Link href='/agreements'>
            <li
              className={routerName === '/agreements' ? 'mb-4 active' : 'mb-4'}
            >
              <a>
          ...
          <Link href='/smart_agreements'>
            <li
              className={
                routerName === '/smart_agreements' ? 'mb-4 active' : 'mb-4'
              }
            >
              <a
                className={routerName === '/smart_agreements' ? 'selected' : ''}
              >
                <img
                  className='mr-3'
                  src='/assets/icon/smartAgreement.svg'
                  alt=''
                />{' '}
                Smart Agreements
              </a>
          ...
          <li className={classnames('mb-4 no-cursor')}>
            ...
            <div>
              <div> {paidToken.toFixed(4)} PAID</div>
              <div>
          ...
          <Link href='/binance_chain'>
            <li
              className={
                routerName === '/binance_chain' ? 'mb-4 active' : 'mb-4'
              }
            >
              <a className={routerName === '/binance_chain' ? 'selected' : ''}>
                <img
                  className='mr-3'
                  src='/assets/icon/binanceSmartChain.svg'
                  alt=''
                />
                Binance Smart Chain
              </a>
